...
class ModelValidationTests(unittest.TestCase):
    def test_catalog_models_are_validator_approved(self):
        for provider, models in get_known_models().items():
            if provider in ("ollama", "openrouter", "aihubmix", "minimax", "custom_openai"):
                continue
    ...
    def test_openrouter_aihubmix_ollama_minimax_and_custom_openai_allow_custom_models(self):
        for provider in ("openrouter", "aihubmix", "ollama", "minimax", "custom_openai"):

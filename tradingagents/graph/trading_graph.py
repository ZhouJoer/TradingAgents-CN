...
class TradingAgentsGraph:
    ...
    def propagate(self, company_name, trade_date, progress_callback=None, task_id=None, review_context=None):
        ...
        init_agent_state = self.propagator.create_initial_state(
            company_name, trade_date, review_context=review_context
        )
